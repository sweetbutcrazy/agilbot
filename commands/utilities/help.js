...
module.exports = {
    ...
    run: async (client, message, args) => {
        ...
        if(!args[0]) {
            ...
            embed.setFooter({ text: `© ${message.guild.me.displayName} | Dev By KINGS`, iconURL: client.user.displayAvatarURL({ dynamic: true })});
            ...
            **Description:** ${command.description || "Official Bot By KINGS"}
